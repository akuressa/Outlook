	...
	if(isset($_POST['create_pdf']))
	{
		...
		else
		{
			...
			if(empty($find_pdf_reference_no))
			{
				...
				$fields="reference_no, pdf_date, no_of_pages, editor_name, left_address, mid_content, product_details, payment_type, product_total, tax_total, grand_total";
				$values=":reference_no, :pdf_date, :no_of_pages, :editor_name, :left_address, :mid_content, :product_details, :payment_type, :product_total, :tax_total, :grand_total";
				$execute=array(
					...
					<div class="col-md-6">
						<form id="add_pdf" name="add_pdf" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form-group" style="padding:6px">
							  ...
							  <textarea name="left_address" class="ckeditor form-control validate[required]" Placeholder="Zahlungsdetails" data-errormessage-value-missing="Adresse ist erforderlich" id="left_address" tabindex="1"><?php echo(isset($_POST['left_address']) && $_POST['left_address']!="" ? $_POST['left_address'] : "");?></textarea>
							</div>
							<div class="form-group" style="padding:6px">
