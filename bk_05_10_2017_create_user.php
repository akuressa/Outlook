<?php
				...
				if($flag_status==true)
				{
					...
					if($add_user > 0)
					{
						...
						if(isset($_SESSION['call_description']) && !empty($_SESSION['call_description']))
						{
							...
							{
								$add_call_note=save(CALL_BACK, "user_id, added_by, call_date, next_call_date, description", ":user_id, :added_by, :call_date, :next_call_date, :description", array(':user_id'=>$add_user, ':added_by'=>$_SESSION['logged_user_id'], ':call_date'=>$_SESSION['call_date'][$key], ':next_call_date'=>$_SESSION['next_call_date'][$key], ':description'=>$values));
							}
						}
						...
						unset($_SESSION['call_description']);unset($_SESSION['call_date']);unset($_SESSION['next_call_date']);
						$doc_flag=true;
	...
	if(isset($_GET['medical_remove_index']))
	{
		...
		{
			$_SESSION['SET_TYPE'] = 'error';
			$_SESSION['SET_FLASH'] = 'Ung&uuml;ltige Behandlungsprotokoll id.';
			header('location:'.DOMAIN_NAME_PATH.'create_user.php');
			exit;
		}
	}
		...
		<div class="col-md-8">
			<div class="panel panel-primary" >
				<div class="panel-heading">
					<h3 class="panel-title">Neuen Kontakt erstellen</h3>
				</div>
				<div class=" content" >
					<div class="col-md-4">
							...
							<div class="message_main_div" id="edit_medical_main_div">
								<div class="col-md-12">
									<form id="edit_medical_log_form" name="edit_medical_log_form" method="post" action="">
										...
										<div class="form-group" style="padding:6px">
										  <label><font color = "red">*</font> Behandlungsprotokoll:</label>
										  <textarea class="form-control validate[required]" Placeholder="Treatement Protocal" id="edit_medical_log" name="edit_medical_log" data-errormessage-value-missing="Behandlungsprotokoll ist erforderlich"><?php echo(isset($_POST['edit_medical_log']) && $_POST['edit_medical_log']!="" ? $_POST['edit_medical_log'] : "");?></textarea>
					...
					<div class="col-md-8">
						<form id="add_user" name="add_user" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form-group" style="padding:6px">
								...
								<div class="col-md-8">
							  		<input class="form-control validate[custom[email]]" placeholder="E-Mail-Addresse" type="text" name="email_address" id="email_address" value="<?php echo((isset($_POST['email_address']) && $_POST['email_address']!='') ? $_POST['email_address'] : "");?>" data-errormessage-value-missing="E-Mail ist erforderlich" maxlength="255" tabindex="6"/>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="form-group" style="padding:6px;display:none;">
							...
							<div class="form-group" style="padding:3px;text-align:right;">
							  ...
							  <button class="button" name = "create_contact" tabindex="13"><b>Neuen Kontakt erstellen</b></button>
							</div>
						</form>
					</div>
				</div>
