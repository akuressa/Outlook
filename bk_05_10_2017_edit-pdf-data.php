<?php
	...
	{
		//print_r($_POST);
		if(isset($_POST['left_address']) && $_POST['left_address']=='')
		{
			$_SESSION['SET_TYPE'] = 'error';
		...
		else
		{
			...
			if(empty($find_pdf_reference_no))
			{
				...
				$value_set="reference_no=:reference_no, pdf_date=:pdf_date, no_of_pages=:no_of_pages, editor_name=:editor_name, left_address=:left_address, mid_content=:mid_content, product_details=:product_details, payment_type=:payment_type, product_total=:product_total, tax_total=:tax_total, grand_total=:grand_total";
				$execute=array(
					...
					<table style="border:0px solid #999;vertical-align: top;font-size:14px;margin-top:100px;width:100%;font-family: Calibri;">
						<tr style="border-bottom: 0px solid #000;padding-bottom:20px;">
							<td style="font-size:14px;vertical-align: top;">
								...
								<?php echo $find_pdf['left_address'];?>
							</td>
