					...
					<div class="col-md-6">
						<form id="add_payment_form" name="add_payment_form" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form-group" style="padding:6px;position:relative;">
							  ...
							  <input class="form-control validate[required]" placeholder="Kundenname" type="text" id="client_name" name="client_name" maxlength="255"  data-errormessage-value-missing="Kundenname erforderlich" tabindex="1" value="<?php echo((isset($_POST['client_name']) && $_POST['client_name']!='') ? $_POST['client_name'] : "");?>" autocomplete="off"/>
							...
							<div class="form-group" style="padding:6px">
							  ...
							  <input class="form-control validate[custom[number]]" placeholder="Betrag bezahlt" type="text" id="amount_paid" name="amount_paid" maxlength="13"  data-errormessage-value-missing="Betrag bezahlt erforderlich" tabindex="3" value="<?php echo((isset($_POST['amount_paid']) && $_POST['amount_paid']!='') ? $_POST['amount_paid'] : "");?>"/>
							</div>
							<div class="form-group" style="padding:6px">
