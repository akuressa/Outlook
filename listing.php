					...
					<table id="myTable" class="table tablesorter">
						<thead class="add_new">
							<tr>
								...
								<th>Telefon</th>
								<th>Niederlassung  <span class="glyphicon glyphicon-chevron-up" style="float:right;margin: 0px 5px;"></span><span class="glyphicon glyphicon-chevron-down" style="float:right"></span></th>
								<th>Status</th>
