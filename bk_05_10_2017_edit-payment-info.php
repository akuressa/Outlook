					...
					<div class="col-md-6">
						<form id="edit_payment_form" name="edit_payment_form" method="post" enctype="multipart/form-data" action="">
							...
							<div class="form-group" style="padding:6px">
							  ...
							  <input class="form-control validate[required]" placeholder="Kundenname" type="text" id="client_name" name="client_name" maxlength="255"  data-errormessage-value-missing="Kundenname erforderlich" tabindex="1" value="<?php echo((isset($_POST['client_name']) && $_POST['client_name']!='') ? $_POST['client_name'] : (isset($find_payment['client_name']) && $find_payment['client_name']!="" ? $find_payment['client_name'] : ""));?>"/>
							</div>
							<div class="form-group" style="padding:6px">
							  <label><font color = "red">*</font> Offener Betrag:</label>
							  <input class="form-control  validate[required, custom[number]]" placeholder="Offener Betrag" type="text" id="amount_due" name="amount_due" maxlength="13"  data-errormessage-value-missing="Offener Betrag erforderlich" tabindex="2" value="<?php echo((isset($_POST['amount_due']) && $_POST['amount_due']!='') ? $_POST['amount_due'] : (isset($find_payment['amount_due']) && $find_payment['amount_due']!="" ? $find_payment['amount_due'] : ""));?>"/>
							</div>
							<div class="form-group" style="padding:6px">
							  <label><font color = "red">*</font> Betrag bezahlt:</label>
							  <input class="form-control validate[required, custom[number]]" placeholder="Betrag bezahlt" type="text" id="amount_paid" name="amount_paid" maxlength="13"  data-errormessage-value-missing="Betrag bezahlt erforderlich" tabindex="3" value="<?php echo((isset($_POST['amount_paid']) && $_POST['amount_paid']!='') ? $_POST['amount_paid'] : (isset($find_payment['amount_paid']) && $find_payment['amount_paid']!="" ? $find_payment['amount_paid'] : ""));?>"/>
							</div>
							<div class="form-group" style="padding:6px">
