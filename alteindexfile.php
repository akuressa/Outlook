			...
			<div style=" width:300px; margin:5% auto">
				<div class="modal-content">
					<div class="modal-header" align="center">
						<img class="img-circle" id="img_logo" src="img/photo.jpg">
					</div>
					<!-- Begin # DIV Form -->
					<div id="div-forms">
						<!-- Begin # Login Form -->
						<form id="login-form" action="" method="post" <?php echo(isset($_POST['forget_submit']) ? 'style="display:none;"' : "");?>>
							<div class="modal-body" >
								...
								<div class="checkbox">
									<label>
										<input type="checkbox" name="remember_me" id="remember_me" value="Y" <?php echo(isset($_COOKIE['cookie_user_remember']) && $_COOKIE['cookie_user_remember']!="" ? "checked=checked" : "");?> tabindex="3"> Erinnere dich an mich
									</label>
								</div>
							</div>
